export const TroveManager = [
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_gasCompensation", type: "uint256" },
      ],
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: "uint32", name: "week", type: "uint32" },
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "collSurplus", type: "uint256" },
      ],
    ...
    },
    {
      ...
      name: "emissionId",
      outputs: [
        { internalType: "uint16", name: "debt", type: "uint16" },
        { internalType: "uint16", name: "minting", type: "uint16" },
      ],
      stateMutability: "view",
      type: "function",
    },
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_collSurplus", type: "uint256" },
        { internalType: "uint256", name: "_debtGasComp", type: "uint256" },
        { internalType: "uint256", name: "_collGasComp", type: "uint256" },
      ],
    ...
    },
    {
      ...
      name: "getTotalMints",
      outputs: [{ internalType: "uint32[7]", name: "", type: "uint32[7]" }],
      stateMutability: "view",
      type: "function",
    },
    {
    ...
    {
      inputs: [
        { internalType: "uint256[]", name: "_assignedIds", type: "uint256[]" },
      ],
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_compositeDebt", type: "uint256" },
        { internalType: "uint256", name: "NICR", type: "uint256" },
        { internalType: "address", name: "_upperHint", type: "address" },
        { internalType: "address", name: "_lowerHint", type: "address" },
        { internalType: "bool", name: "_isRecoveryMode", type: "bool" },
      ],
      name: "openTrove",
      outputs: [
        { internalType: "uint256", name: "stake", type: "uint256" },
        { internalType: "uint256", name: "arrayIndex", type: "uint256" },
      ],
      stateMutability: "nonpayable",
      type: "function",
    },
    ...
    {
      inputs: [
        { internalType: "uint256", name: "_minuteDecayFactor", type: "uint256" },
        { internalType: "uint256", name: "_redemptionFeeFloor", type: "uint256" },
        { internalType: "uint256", name: "_maxRedemptionFee", type: "uint256" },
        { internalType: "uint256", name: "_borrowingFeeFloor", type: "uint256" },
        { internalType: "uint256", name: "_maxBorrowingFee", type: "uint256" },
        { internalType: "uint256", name: "_interestRateInBPS", type: "uint256" },
        { internalType: "uint256", name: "_maxSystemDebt", type: "uint256" },
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_netDebtChange", type: "uint256" },
    ...
    },
    {
      ...
      name: "vault",
      outputs: [
        { internalType: "contract IPrismaVault", name: "", type: "address" },
      ],
      stateMutability: "view",
      type: "function",
    },
